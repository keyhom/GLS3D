...
if os.name == 'posix':
    ...
    if platform.system().startswith('CYGWIN'):
        # compilation_database_folder = 'proj.cygwin'
        flags = [
          '-Werror',
          '-Wno-write-strings',
          '-Wno-trigraphs',
        ...
        compilation_database_folder = 'proj.linux'
    elif platform.system().startswith('MINGW'):
        compilation_database_folder = 'proj.mingw32'
    elif platform.system().startswith('Darwin'):
        compilation_database_folder = 'proj.mac'
else:
    flags = [
        '-Werror',
        '-Wno-write-strings',
